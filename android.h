...
extern struct selabel_handle *
selinux_android_keystore2_key_context_handle(void);
 ...
 * failed */
extern int selinux_android_setcontext(uid_t uid, bool isSystemServer,
...
extern int selinux_android_context_with_level(const char *context,
                                              char **newContext, uid_t userid,
                                              uid_t appid);

/* Provides a log callback that uses the Android logging facility. See
